...
function resolve(id, rawopts) {
	...
	if (ends_with_sass_extension(base) || ends_with_css_extension(base)) {
		...
		test_file((0, _path.join)(dir, base, 'index.scss'), opts),
		// test whether `dir/base/index.sass` exists
		test_file((0, _path.join)(dir, base, 'index.sass'), opts),
		// test whether `dir/base/_index.scss` exists
		test_file((0, _path.join)(dir, base, '_index.scss'), opts),
		// test whether `dir/base/_index.sass` exists
		test_file((0, _path.join)(dir, base, '_index.sass'), opts));
